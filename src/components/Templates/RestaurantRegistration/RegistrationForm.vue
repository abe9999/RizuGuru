<template>
  <div class="basic">
    ...
    <SelectFormUnit
      ...
      :setter="selectFormSetter"
      :propertyName="selectForm.propertyName"
...
export default {
  ...
  props: {
    ...
    selectFormGetter: Function,
    selectFormSetter: Function,
    selectFormValidationStateSetter: Function,
    textFormList: Object,
    selectFormList: Object,
    tagFormList: Object,
